...
class CubeTransitionIndicator : Indicator() {
    ...
    override fun onCreateAnimators(): ArrayList<ValueAnimator> {
        ...
        for (i in 0..1) {
            translateX[i] = startX
            var translationXAnim = ValueAnimator.ofFloat(
                startX,
                width - startX,
                width - startX,
                startX,
            ...
            if (i == 1) {
                translationXAnim = ValueAnimator.ofFloat(
                    width - startX,
                    startX,
                    startX,
                    width - startX,
            ...
            translateY[i] = startY
            var translationYAnim = ValueAnimator.ofFloat(
                startY,
                startY,
                height - startY,
                height - startY,
            ...
            if (i == 1) {
                translationYAnim = ValueAnimator.ofFloat(
                    height - startY,
                    height - startY,
                    startY,
                    startY,
        ...
        val rotateAnim =
            ValueAnimator.ofFloat(0f, 180f, 360f, 1.5f * 360, 2 * 360.toFloat())
