...
import com.sycode.indicatorview.indicators.BallPulseIndicator

class SYLoadingIndicatorView : View {
    ...
    var mMaxHeight = 0
      ...
      var mShouldStartAnimationDrawable = false
    ...
    constructor(
        ...
        init(context, attrs, 0, R.style.SYLoadingIndicatorView)
    }
    ...
    constructor(
        ...
        init(context, attrs, defStyleAttr, R.style.SYLoadingIndicatorView)
    }
    ...
    constructor(
      ...
      fun init(
        ...
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.SYLoadingIndicatorView, defStyleAttr, defStyleRes
        )
        mMinWidth = a.getDimensionPixelSize(R.styleable.SYLoadingIndicatorView_minWidth, mMinWidth)
        mMaxWidth = a.getDimensionPixelSize(R.styleable.SYLoadingIndicatorView_maxWidth, mMaxWidth)
        mMinHeight =
            a.getDimensionPixelSize(R.styleable.SYLoadingIndicatorView_minHeight, mMinHeight)
        mMaxHeight =
            a.getDimensionPixelSize(R.styleable.SYLoadingIndicatorView_maxHeight, mMaxHeight)
        val indicatorName =
            a.getString(R.styleable.SYLoadingIndicatorView_indicatorName)
        mIndicatorColor = a.getColor(
            R.styleable.SYLoadingIndicatorView_indicatorColor,
            Color.WHITE
        )
...
// queue, which can prevent the entire view hierarchy from being GC'ed during a rotation
    ...
    companion object {
          const val TAG = "SYLoadingIndicatorView"
          val DEFAULT_INDICATOR = BallPulseIndicator()
          const val MIN_SHOW_TIME = 500 // ms
          const val MIN_DELAY = 500 // ms
    }
}